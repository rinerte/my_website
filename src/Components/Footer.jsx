...
function Footer() {
  return (
    <div className='hidden md:flex justify-center items-center h-[49px] border-t-[1px] border-line backdrop-blur-md z-10'>
        ...
        <a href="https://github.com/rinerte" className='hover:brightness-200 hover:border-primaryLight flex justify-center items-center h-full w-[200px] border-l-[1px] border-line text-[16px] text-secondaryGray' >
          <span className='pr-[10px] '>@rinerte</span> 
